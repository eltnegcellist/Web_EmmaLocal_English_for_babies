const CACHE='emma-web-shell-v74';
const SHELL=['./','./index.html','./reset.html','./styles.css','./manifest.webmanifest','./icons/mitsukotoba.png','./src/app.js','./src/moonshine-module.js','./src/audio-capture.js','./src/lite-response-engine.js','./src/lite-phonetic-scene-matcher.js','./src/name-pronunciation.js','./src/tts-worker.js','./worklets/pcm-capture-worklet.js','./src/vendor/kitten/index.js','./src/vendor/kitten/kitten-tts.js','./src/vendor/kitten/model-loader.js','./src/vendor/kitten/npz-loader.js','./src/vendor/kitten/phonemizer.js','./src/vendor/kitten/audio.js','./src/vendor/kitten/preprocess.js','./src/vendor/kitten/text-cleaner.js'];
