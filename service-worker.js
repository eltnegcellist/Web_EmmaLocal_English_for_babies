const CACHE='emma-web-shell-v1';
const SHELL=['./','./index.html','./styles.css','./manifest.webmanifest','./icons/emma.svg','./src/app.js','./src/audio-capture.js','./src/lite-response-engine.js','./src/asr-worker.js','./src/tts-worker.js','./worklets/pcm-capture-worklet.js'];
